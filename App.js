    ...
    return(
        <div className="body">
            ...
            <div className="rest-container">
                <RestaurantCard restData={resList[0]}/>
                <RestaurantCard restData={resList[1]}/>
                <RestaurantCard restData={resList[2]}/>
                <RestaurantCard restData={resList[3]}/>
                <RestaurantCard restData={resList[4]}/>
                <RestaurantCard restData={resList[5]}/>
                <RestaurantCard restData={resList[6]}/>
                <RestaurantCard restData={resList[7]}/>
                <RestaurantCard restData={resList[8]}/>
